...
class Test_TestReturn(unittest.TestCase):
    ...
    def test_book_return_wrong_item(self):
        self.assertEqual(script.Library().book_return('cos', 1, 'Nowak'), 'Wrong book')

    def test_book_return_wrong_name(self):
        self.assertEqual(script.Library().book_return('brysiu', 1, 'Nowak12['), 'Wrong name')

    def test_book_returnlack_of__name(self):
        self.assertEqual(script.Library().book_return('brysiu', 1, ''), 'No name')

    def test_book_return_wrong_quantity(self):
        self.assertEqual(script.Library().book_return('brysiu', '[aa]', 'Nowak'), 'Wrong quantity')

    def test_book_return_quantity_less_than_0(self):
        self.assertEqual(script.Library().book_return('brysiu', -3, 'Nowak'), 'Quantity equal or less than 0')
